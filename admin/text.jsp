            ...
            <div class="col-md-6 offset-md-3">
                <div class="card">
                    ...
                    <% } 
                            ...
                            <div class="mb-3">
                                <label class="my-1 mr-2" for="tname">Test Name</label>
                                <input type="text" name="tname" placeholder="Text Name" id="tname" class="form-control form-lg fs-6 " required>
                            </div>
                            <div class="mb-3">
                                <label class="my-1 mr-2" for="mark">Total Mark's</label>
                                <input type="number" name="mark" placeholder="Mark" id="mark" class="form-control form-lg fs-6 " required>
                            </div>
                            <div class="form-group">
                                <button type="submit" class="btn btn-primary btn-lg" onclick="return p1()">Create</button>
                            </div>
                        </form>
                    </div>
                </div>
