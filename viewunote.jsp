        ...
        <div class="container p-2">
            ...
            <div class="row">
                ...
                try
                {
                    ...
                    String query="select * from note where email='"+email+"'";
                ...
                <div class="col-md-3 p-3">
                    <div class="card crd-ho">
                        <div class="card-body text-center">
                            ...
                            <div class="row ">
                                <div class="col-6">
                                    <a href="editnote.jsp?id=<%= rs.getString(1) %>" class="btn btn-success ">Edit </a>
                                </div>
                                <div class="col-6">
                                    <a href="DeleteUNote?id=<%= rs.getString(1) %>" class="btn btn-danger  ">Delete </a>
                                </div>
                            </div>
                        </div>
                    </div>
